...
assert.doesNotMatch(
  ...
  "login/index.astro MUST NOT be prerendered since it handles POST requests",
);
...
assert.match(
  ...
  "LinkItem.astro image should have loading='lazy'",
);
assert.match(
  linkItem,
  /<(?:img|Image)[^>]*decoding=["']async["']/,
  "LinkItem.astro image should have decoding='async'",
);
...
assert.match(
  catalogAppCard,
  /<img[^>]*loading=["']lazy["']/,
  "CatalogAppCard.astro img should have loading='lazy'",
);
assert.match(
  catalogAppCard,
  /<img[^>]*decoding=["']async["']/,
  "CatalogAppCard.astro img should have decoding='async'",
);
