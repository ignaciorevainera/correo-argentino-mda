...
export function calculateCompliance(
  ...
  estipulado: string | null | undefined,
) {
...
export const complianceClasses: Record<string, string> = {
  ...
  Cumplió:
    "badge-success text-success-content dark:bg-emerald-950/20 dark:text-emerald-400",
  Incumplió:
    "badge-error text-error-content dark:bg-rose-950/20 dark:text-rose-400",
  "Llegada Tarde":
    "badge-warning text-warning-content dark:bg-amber-950/20 dark:text-amber-400",
};
