...
export const POST: APIRoute = async ({ request, locals }) => {
  ...
  try {
    ...
    // Actualización masiva de orden y categoría para aplicativos
    db.transaction((tx) => {
    ...
    await logAdminAction(
      ...
      `Reordenó y/o recategorizó ${items.length} aplicativos`
    );
    ...
    console.error("[Reorder Aplicativos API] Error:", err);
    return new Response(
